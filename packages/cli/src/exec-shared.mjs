...
export function buildExecPrompt({ taskId, taskPack }) {
  ...
  return [
    ...
    '',
    'IMPORTANT: You are in fully autonomous mode. Do NOT ask any questions. Do NOT ask for approval.',
    'For any open questions in the task pack, use sensible defaults (use Stripe for payments, React for UI).',
    'Say ONE sentence about what you will implement, then IMMEDIATELY call Write or Edit to create the first file.',
