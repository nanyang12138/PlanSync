...
export function buildExecPrompt({ taskId, taskPack }) {
  ...
  return [
    ...
    '',
    'IMPORTANT: You are in fully autonomous mode. Skip plan mode approval.',
    'Briefly state what you will implement (2 sentences), then IMMEDIATELY start writing files with Write/Edit tools.',
